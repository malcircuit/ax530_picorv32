...
set_location_assignment PIN_R6 -to usb_sloe_dup
set_location_assignment PIN_Y1 -to usb_slrd_dup
set_location_assignment PIN_V4 -to usb_slwr_dup
set_location_assignment PIN_Y2 -to usb_fd_dup[0]
set_location_assignment PIN_N7 -to usb_fd_dup[1]
set_location_assignment PIN_N6 -to usb_fd_dup[2]
set_location_assignment PIN_R7 -to usb_fd_dup[3]
set_location_assignment PIN_P6 -to usb_fd_dup[4]
set_location_assignment PIN_P1 -to usb_fd_dup[5]
set_location_assignment PIN_P3 -to usb_fd_dup[6]
set_location_assignment PIN_R2 -to usb_fd_dup[7]
set_location_assignment PIN_P5 -to usb_fd_dup[8]
set_location_assignment PIN_AA1 -to usb_fd_dup[9]
set_location_assignment PIN_V3 -to usb_fd_dup[10]
set_location_assignment PIN_W2 -to usb_fd_dup[11]
set_location_assignment PIN_W1 -to usb_fd_dup[12]
set_location_assignment PIN_T5 -to usb_fd_dup[13]
set_location_assignment PIN_T4 -to usb_fd_dup[14]
set_location_assignment PIN_U1 -to usb_fd_dup[15]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to clk_dup
